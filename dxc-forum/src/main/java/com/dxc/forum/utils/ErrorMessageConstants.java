...
public class ErrorMessageConstants {
	...
	public static final String PROPER_CERTIFICATE_REMARKS = "Please provide certification remarks, it's Null";
	...
	public static final String PROPER_CERTIFICATION_VOUCHER = "Certificate Voucher is null";
	...
	public static final String PROPER_RFP_TITLE = "Please send proper RFP Title, It's blank";
	
	public static final String PROPER_RFP_CLIENT = "Please send proper RFP Client, It's blank";
	
	public static final String PROPER_RFP_STATUS = "Please send proper RFP Status, It's blank";
	
	public static final String PROPER_RFP_REGION = "Please send proper RFP Region, It's blank";
	
	public static final String PROPER_RFP_TECHNOLOGY = "Please send proper RFP Technology, It's blank";
	
	public static final String PROPER_RFP_JAVA_TEAM = "Please send proper RFP JAVA Team, It's blank";
	
	public static final String PROPER_RFP_DXC_SOLUTIONING_LEAD = "Please send proper RFP DXC Solutioning Lead, It's blank";
	
	public static final String PROPER_RFP_TYPE = "Please send proper RFP Type, It's blank";
	
	public static final String PROPER_RFP_NOTES = "Please send proper RFP Notes, It's blank";
	
	public static final String PROPER_RFP_TOTAL_DEAL_VALUE = "Please send proper RFP Total Deal Value, It's blank";
	
	public static final String PROPER_RFP_OPX_ID = "Please send proper RFP OPX ID, It's blank";
	
	public static final String PROPER_RFP_DATE_OF_ENTRY = "Please send proper RFP Date Of Entry, It's blank";
	
	public static final String PROPER_RFP_ETA_SUBMIT = "Please send proper RFP ETA Submit, It's blank";
	
	public static final String PROPER_RFP_REALIZATION_DATE = "Please send proper RFP Realization Date, It's blank";
	
	public static final String PROPER_RFP_TCV_USD = "Please send proper RFP TCV USD, It's blank";
	
	public static final String PROPER_RFP_EFFORT = "Please send proper RFP Effort, It's blank";
	
	public static final String PROPER_RFP_PROJECT_PLANNED_STATUS = "Please send proper RFP Project Planned Status, It's blank";

	public static final String RFP_ID_NULL = "Given RFP id is null, please send some id to be searching";
	
	public static final String RFPPHASES_ID_NULL = "Given RFPPhases id is null, please send some id to be searching";
	
	public static final String PROPER_RFPPHASES_PHASES = "Give proper phase value, it's blank";
	
	public static final String PROPER_RFPPHASES_ESTIMATION_VARIABLE = "Give proper estimation value, it's blank";
	
	public static final String PROPER_RFPPHASES_EFFORT_PH = "Give proper effort ph value, it's blank";
	
	public static final String PROPER_RFPPHASES_EFFORT_MAN_MONTHS = "Give proper effort man months value, it's blank";
}
